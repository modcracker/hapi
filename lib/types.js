...
function Types(){
  ...
  this.load(path.join(__dirname, "./types/"));
  
  return this;
}

/*
 * Throws Error if baseObj is invalid
 *
 * @param {String} name
 * @param {Object} baseObj
 * @api public
 */
Types.prototype.assertValidType = function(name, baseObj){
  // Must have a non-blank name
  if (typeof name === "undefined" || name === null || name === ""){
    throw "The name of a Type cannot be undefined, null, or blank";
  }
  
  // Must be an object
  if (typeof baseObj !== "object"){
    throw "Type " + name + " must be of type object";
  }
  ...
  if (typeof baseObj.validate == "undefined" || baseObj.validate === null || typeof baseObj.validate !== "function"){
    throw "The '" + name + "' Type must provide a .validate() function";
  }
...
Types.prototype.get = function(name, baseObj){
  if (typeof baseObj !== "undefined" && baseObj !== null){
    this.assertValidType(name, baseObj); // Throws error on invalid Types
